...
-- The function can_participate_in_exam has been moved to migration6.sql
...
-- user_ongoing_exams and user_exams_history views have been moved to migration7.sql
